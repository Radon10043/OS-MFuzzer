...
>> Note that the _ptrace_ check is not strictly necessary to prevent B/2/i, it
...
last limitation with a ‘user_allow_other’ config option. If this config option
is set, the mounting user can add the ‘allow_other’ mount option which
...
[Next ](fuse-io.html "Fuse I/O Modes") [ Previous](hpfs.html "Read/Write HPFS
2.09")
