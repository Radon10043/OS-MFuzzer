...
<table class="docutils align-default"><colgroup><col> <col></colgroup><tbody><tr class="row-odd"><td><p>KVM_VCPUEVENT_VALID_NMI_PENDING</p></td><td><p>transfer nmi.pending to the kernel</p></td></tr><tr class="row-even"><td><p>KVM_VCPUEVENT_VALID_SIPI_VECTOR</p></td><td><p>transfer sipi_vector</p></td></tr><tr class="row-odd"><td><p>KVM_VCPUEVENT_VALID_SMM</p></td><td><p>transfer the smi sub-struct.</p></td></tr></tbody></table>
