...
(See [Scalable Vector Extension support for AArch64 Linux](https://www.kernel.org/doc/html/v6.7/arch/arm64/sve.html) for an explanation of the "vq" nomenclature.)
...
(See [ARM Hypercall Interface](https://www.kernel.org/doc/html/v6.7/virt/kvm/arm/hypercalls.html) for more details.)
...
| 0x80x0 0000 0300 0004 | sepc     | Supervisor exception program unter          |
| 0x80x0 0000 0300 0005 | scause   | Supervisor trap cause                       |
| 0x80x0 0000 0300 0006 | stval    | Supervisor bad address or struction         |
| 0x80x0 0000 0300 0007 | sip      | Supervisor interrupt pending                |
| 0x80x0 0000 0300 0008 | satp     | Supervisor address translation d protection |
...
| 0x8030 0000 0400 0002 | compare   | Time compare programmed by est       |
| 0x8030 0000 0400 0003 | state     | Time compare state (1 = ON or = OFF) |
...
| 0x8020 0000 0500 0020 | fcsr     | Floating point control and atus gister |
...
| 0x8020 0000 0600 0020 | fcsr     | Floating point control and atus gister |
...
Returns: \= 0 on success, < 0 on generic error (e.g. -EFAULT or -ENOMEM), 16 bit program exception code if the access causes such an exception
...
See [The KVM halt polling system](https://www.kernel.org/doc/html/v6.7/virt/kvm/halt-polling.html) for more information on halt polling.
...
See [Software Guard eXtensions (SGX)](https://www.kernel.org/doc/html/v6.7/arch/x86/sgx.html) for more details.
