...
-EFAULT: if the pointer is invalid</p></td></tr></tbody></table>
...
|0x6040 0000 0010 0054 |V0 |128 |fp_regs.vregs[0] [1](#id8) |
|0x6040 0000 0010 0058 |V1 |128 |fp_regs.vregs[1] [1](#id8) |
|... |  |  |  |
|0x6040 0000 0010 00d0 |V31 |128 |fp_regs.vregs[31] [1](#id8) |
...
Access to register IDs where 2048 * slice >= 128 * max_vq will fail with ENOENT. max_vq is the vcpu’s maximum supported vector length in 128-bit quadwords: see [2](#id10) below.
...
(See [Scalable Vector Extension support for AArch64 Linux](https://www.kernel.org/doc/html/v5.15/arm64/sve.html) for an explanation of the “vq” nomenclature.)
...
Returns: 0 on success, KVM_S390_GET_KEYS_NONE if guest is not using storage keys, negative value on error
...
See [Software Guard eXtensions (SGX)](https://www.kernel.org/doc/html/v5.15/x86/sgx.html) for more details.
...
This capability indicates that KVM supports steal time accounting. When steal time accounting is supported it may be enabled with architecture-specific interfaces. This capability and the architecture- specific interfaces must be consistent, i.e. if one says the feature is supported, than the other should as well and vice versa. For arm64 see [Generic vcpu interface](https://www.kernel.org/doc/html/v5.15/virt/kvm/devices/vcpu.html) “KVM_ARM_VCPU_PVTIME_CTRL”. For x86 see [KVM-specific MSRs](https://www.kernel.org/doc/html/v5.15/virt/kvm/msr.html) “MSR_KVM_STEAL_TIME”.
